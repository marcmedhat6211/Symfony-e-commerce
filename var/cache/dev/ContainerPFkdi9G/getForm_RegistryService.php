...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\CreateAccessoryFormType' => ['privates', 'App\\Form\\CreateAccessoryFormType', 'getCreateAccessoryFormTypeService', true],
            'App\\Form\\CreateCategoryFormType' => ['privates', 'App\\Form\\CreateCategoryFormType', 'getCreateCategoryFormTypeService', true],
            'App\\Form\\CreateProductFormType' => ['privates', 'App\\Form\\CreateProductFormType', 'getCreateProductFormTypeService', true],
            'App\\Form\\EditCategoryFormType' => ['privates', 'App\\Form\\EditCategoryFormType', 'getEditCategoryFormTypeService', true],
            'App\\Form\\EditProductFormType' => ['privates', 'App\\Form\\EditProductFormType', 'getEditProductFormTypeService', true],
            'App\\Form\\RegisterUserFormType' => ['privates', 'App\\Form\\RegisterUserFormType', 'getRegisterUserFormTypeService', true],
            ...
            'App\\Form\\CreateAccessoryFormType' => '?',
            'App\\Form\\CreateCategoryFormType' => '?',
            'App\\Form\\CreateProductFormType' => '?',
            'App\\Form\\EditCategoryFormType' => '?',
            'App\\Form\\EditProductFormType' => '?',
            'App\\Form\\RegisterUserFormType' => '?',
